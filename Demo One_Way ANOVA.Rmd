...
```{r}
anova(data = dat_A, dep = 'Self_esteem', factors = c('Style'), effectSize = 'partEta', postHoc = c('Style'), postHocCorr = 'tukey', homo = TRUE, desc = TRUE)
...
```{r}
anova(data = dat_B, dep = 'Self_esteem', factors = c('Style'), effectSize = 'partEta', postHoc = c('Style'), postHocCorr = 'tukey', homo = TRUE, desc = TRUE)
...
anova(data = dat_C, dep = 'Self_esteem', factors = c('Style'), effectSize = 'partEta', postHoc = c('Style'), postHocCorr = 'tukey', homo = TRUE, desc = TRUE)
