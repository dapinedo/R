---
title: "Equity Valuation - Present Value"
...
[6] Less: Interest Expense           # Compensation to debt holders (not included in unlevered model)
====================================
[7] Pre-Tax Income                   
...
FCFF model (unlevered) forecasts free cash flows for equity and debt and uses WACC multiplier
FCFE model forecasts free cash flows for equity accounting for debt and uses Cost of Equity / Capital
...
Calculating FCFF model (unlevered)
     1. EBIT * (1-Tax Rate) + Non-Cash Expenses – Changes in Operating Assets & Liabilities – CapEx
     2. Cash Flow from Operations + Tax Adjusted Interest Expense – CapEx
     3. Net Income + Tax Adjusted Interest Expense + Non-Cash Expenses – Changes in Operating Assets & Liabilities – CapEx 


Calculating FCFE model (levered)
     1. Net Income + Net Debt Issued (Repaid) + Non-Cash Charges – Changes in Operating Assets & Liabilities – CapEx 
     2. Cash Flow from Operations – CapEx + Net Debt Issued (Repaid)
     
Adjustments to Arrive to FCFE (Using #1 above)
[9] After-Tax Income                     # Net Income 
...
#Terminal Value
using perpetuity with growth model (PGM) using FCFE
```{r}
