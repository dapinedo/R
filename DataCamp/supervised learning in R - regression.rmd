...
- `Educ`: year of education to time of survey
...
- Linear regression values in $[-\infty, \infty]$
...
`designTreatmentsZ()` returns a list with an element 

`scoreFrame`: a data frame that includes the names and types of the new variables:
