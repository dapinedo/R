...
- [http://adv-r.had.co.nz/OO-essentials.html#s4](http://adv-r.had.co.nz/OO-essentials.html#s4)
...
- `tm_shape()` defines default data for any subsequent layers, so you can have many in a single plot
...
Take a look at your [static map](_images/population.png) and [interactive map](_html/population.html).
...
Take look at your [interactive version](_html/prop_18-24.html)! Do you have any ideas for out what the areas are with a very high proportion of 18-24 year olds? Zoom in on one and see if you are right.
...
For your map, you want neighborhood boundaries. We downloaded the Neighborhood Tabulation Areas, as defined by the City of New York, from the [Open Data Platform of the Department of City Planning](https://www1.nyc.gov/site/planning/data-maps/open-data/dwn-nynta.page). The download was in the form of a zip archive and we have put the result of unzipping the downloaded file in your working directory.
...
A common kind of raster file is the GeoTIFF, with file extension `.tif` or `.tiff`. We've downloaded a median income raster from the [US census](http://sedac.ciesin.columbia.edu/data/collection/usgrid) and put it in your working directory.
...
Take a look at your [final plot](_images/nyc_income_map.png)!
