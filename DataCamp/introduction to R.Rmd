...
```{r calculating-total-winnings-(2)}
# Poker winnings from Monday to Friday:
poker_vector <- c(140, -50, 20, -120, 240)
...
```{r calculating-total-winnings-(3)}
...
```{r vector-selection:-the-good-times}
# Poker winnings from Monday to Friday
poker_vector <- c(140, -50, 20, -120, 240)
...
```{r vector-selection:-the-good-times-(2)}
# Poker winnings from Monday to Friday
poker_vector <- c(140, -50, 20, -120, 240)
...
```{r vector-selection:-the-good-times-(3)}
# Poker winnings from Monday to Friday
poker_vector <- c(140, -50, 20, -120, 240)
...
```{r vector-selection:-the-good-times-(4)}
# Poker and roulette winnings from Monday to Friday:
poker_vector <- c(140, -50, 20, -120, 240)
roulette_vector <- c(-24, -50, 100, -350, 10)
days_vector <- c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday")
...
```{r selection-by-comparison-Step-1}
# Poker winnings from Monday to Friday
poker_vector <- c(140, -50, 20, -120, 240)
...
```{r selection-by-comparison-step-2}
# Poker winnings from Monday to Friday
poker_vector <- c(140, -50, 20, -120, 240)
...
```{r calculating-the-worldwide-box-office}
# Construct star_wars_matrix
...
```{r adding-a-column-for-the-worldwide-box-office}
# Construct star_wars_matrix
box_office <- c(460.998, 314.4, 290.475, 247.900, 309.306, 165.8)
region <- c("US", "non-US")
titles <- c("A New Hope", 
...
```{r the-total-box-office-revenue-for-the-entire-saga}
...
```{r a-little-arithmetic-with-matrices}
# all_wars_matrix is available in your workspace
all_wars_matrix
...
```{r a-little-arithmetic-with-matrices-(2)}
...
```{r whats-a-factor-and-why-would-you-use-it?}
...
```{r whats-a-factor-and-why-would-you-use-it?-(2)}
# Sex vector
sex_vector <- c("Male", "Female", "Female", "Male", "Male")
...
```{r whats-a-factor-and-why-would-you-use-it?-(3)}
# Animals
...
```{r quick-have-a-look-at-your-data-set}
# Call head() on mtcars
head(mtcars)
```
...
```{r have-a-look-at-the-structure}
...
```{r selection-of-data-frame-elements}
...
```{r selection-of-data-frame-elements-(2)}
# The planets_df data frame from the previous exercise is pre-loaded
...
```{r only-planets-with-rings-but-shorter}
# planets_df is pre-loaded in your workspace
...
```{r lists-why-would-you-need-them?}
...
```{r lists-why-would-you-need-them?-(2)}
...
```{r selecting-elements-from-a-list}
...
```{r creating-a-new-list-for-another-movie}
