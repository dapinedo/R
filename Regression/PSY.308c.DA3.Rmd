...
H~a~: income + illiteracy + safety predict success + graduation status
N = 50
...
Income, Illiteracy, and Graduation predict 62% of variance for Success (no significant added account for variance)

Based on literature, Graduation and Safety are best predictors of success.  In this case, graduation did not account for a significantly greater amount of variance when added to Income and Illiteracy, Income accounted for highest amount of overall variance by itself, and income and illiteracy accounted for the most parsimonious model overall.
